...
(function () {
    ...
    position: relative;
    user-select: none;
    padding: 9px 14px 8px 14px !important;}#clipping-preview{border:1px solid #CCC;width:0;height:0;margin:0;background-repeat:no-repeat;background-position:center;}.clipping-confirm:hover{color: #409eff;border-color: #c6e2ff;background-color: #ecf5ff;}.clipping-confirm.primary{    color: #FFFFFF;
    background-color: #217ebd;
    border-color: #217ebd;}.clipping-confirm.primary:hover{color: #fff;border-color: #66b1ff;background-color: #66b1ff;}.clipping-confirm-box .clipping-confirm:last-child{margin-right:0;}`;
		this.init();
	}
	Clip.prototype = {
		init(){
			...
			this.opt.minHeight = this.opt.minHeight < 30 ? 300 : this.opt.minHeight;
			this.opt.minWidth = this.opt.minWidth < 30 ? 300 : this.opt.minWidth;
			this.opt.initialHeight = this.opt.initialHeight < 30 ? 300 : this.opt.initialHeight < this.opt.minHeight ? this.opt.minHeight : this.opt.initialHeight;
			this.opt.initialWidth = this.opt.initialWidth < 30 ? 300 : this.opt.initialWidth < this.opt.minWidth ? this.opt.minWidth : this.opt.initialWidth;
